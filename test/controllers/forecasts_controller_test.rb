...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference('Forecast.count') do
      post forecasts_url, params: { forecast: { date: @forecast.date, day: @forecast.day, forecast: @forecast.forecast } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { date: @forecast.date, day: @forecast.day, forecast: @forecast.forecast } }
